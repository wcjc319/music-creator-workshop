      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">登录您的账户继续使用</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-gray-400 cursor-pointer">
                <input
                  type="checkbox"
                  className="mr-2 w-4 h-4 rounded bg-white/5 border-white/10 text-purple-500 focus:ring-purple-500/20"
                />
                记住我
              </label>
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white h-11 rounded-lg group"
            >
              {loading ? '登录中...' : (
                <>
                  <span>登录</span>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 text-gray-400 bg-transparent">或</span>
            </div>
          </div>
